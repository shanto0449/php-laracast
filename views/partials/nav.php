       ...
       <div class="flex items-center">
         ...
         <div class="hidden md:block">
           <div class="ml-10 flex items-baseline space-x-4">
             ...
             <a href="/notes" class=" <?= urlIs('/notes') ? 'bg-gray-900 text-white' : 'text-gray-300' ?>  hover:bg-gray-700 px-3 py-2 text-sm font-medium">Notes</a>
              <?php endif; ?>
        ...
        <div class="ml-4 flex items-center md:ml-6">
          ...
          <div class="ml-3 flex items-center space-x-3">
            <?php if (!empty($_SESSION['user'])): ?>
              <button class="relative flex items-center rounded-full focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">
                <span class="absolute -inset-1.5"></span>
              ...
              <div>
                <form action="/session" method="post">
                  ...
                  <button  class="<?= urlIs('/logout') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 px-3 py-2 text-sm font-medium">Log Out</button>
                  
                </form>
              </div>
            <?php else: ?>
              <a href="/register" class="<?= urlIs('/register') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 px-3 py-2 text-sm font-medium">Register</a>
              <a href="/login" class="<?= urlIs('/login') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 px-3 py-2 text-sm font-medium">Login</a>
            <?php endif; ?>
          </div>
        </div>
      </div>
